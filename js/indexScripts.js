...
function setUpCustomFields($fields) {
		...
		for (var i = 0; i < $fields.length; i++) {
				...
				'<div class="input-control text" data-role="input-control" style="margin:5px 0; background-color: transparent;">' +
