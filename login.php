...
<body class="metro">
    ...
    //         header('Location: ' . $_GET['redirect'] . $invite_param);
    //         exit;
    //     } else {
    //         $invite_param = isset($_GET['invite']) ? 'invite=' . $_GET['invite'] : '';

    //         header('Location: index.php?' . $invite_param);
    //         exit;
    //     }
    // }
    ...
    //     // header('Location: ' . $_GET['redirect'] . '?invite=' . $_GET["invite"]);
    //     exit;
    // }
    ?>
    <div id="wrapper">
            ...
            <div id="login-form" style="width:500px; margin:auto">
                <fieldset>
                    ...
                    <div style="margin-top: 20px">
                        ...
                        <br/>
                        <button style="margin-top:10px" id="anonymous" class="button default">
                            Login Anonymous
                        </button>
                    </div>
                </fieldset>
