<?php
/**
 * This php file will create a nwe imageset, and then return the ID from the newly created imageset
...
if(isset($_GET['stopImageset'])) {
		...
		echo "Successfully stopped imgset";
		return;
}
...
try {
    ...
    $sql = "INSERT INTO `db_quickeval`.`pictureset` (`id`, `name`, `text`, `pictureAmount`, `person`) VALUES (NULL, ?, ?, ? ,?);";
	$sth = $db->prepare($sql);
