                    ...
                    <fieldset>
                        ...
                        <div class="grid" style="margin:0">
                            <div class="row" style="margin:0">
                                <label class="span3"  >Sex</label>
                                <label class="span3" style="margin-left: 60px;">Date of Birth</label>
                            </div>
                            <div class="row" style="margin:0">
                                <div class="input-control select span3" style="margin-right: 40px;">
                                ...
                                <div id="calendar-div" class="input-control text span3" style="margin-left:20px">
                                    <input id="calendar" name="dob" type="text" placeholder="dd.mm.yyyy">
                                    <button id="register-date" class="btn-date"></button>
                                </div>
                            </div>
                        </div>
