<?php
/**
 * File used to search for an experiment based on a number of different variables.
 */
require_once('../../db.php');
...
try {
    ...
    $subQuery = $subQuery . " AND e.isPublic = '1 = Public' ";
    ...
    if (isset($_POST['experiment'])) {
        ...
        $subQuery = $subQuery . " ORDER BY title ASC, RAND() LIMIT 0, 15 "; 
    }
