...
try {
  ...
  $stmt = $db->prepare(
    "SELECT experimentOrder.pictureQueue " .
    "FROM experimentqueue, experimentOrder " .
    "WHERE experimentqueue.experiment = :id " .
    "AND experimentorder.experimentQueue = experimentqueue.id " .
    "AND experimentorder.pictureQueue IS NOT NULL"
  );
