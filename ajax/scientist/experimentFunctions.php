...
if($_SESSION['user']['userType'] > 2) {
    ...
    $sth->bindParam(3,$forcedPick);
    $sth->bindParam(4,$showOriginal);
    $sth->bindParam(5,$samePairTwice);
	$sth->bindParam(6, $timer);
    $sth->bindParam(7, $experimentId);
    $sth->execute();  
}
