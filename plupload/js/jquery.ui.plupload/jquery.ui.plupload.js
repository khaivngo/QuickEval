...
(function(window, document, plupload, o, $) {
    ...
    function renderUI(obj) {
        ...
        obj.html(
                ...
                '<table class="plupload_filelist plupload_filelist_footer ui-widget-header" style="width:100%;">' +
                '<tr>' +
                '<td class="plupload_cell plupload_file_name">' +
                '<div class="plupload_buttons"><!-- Visible -->' +
                '<button class=" primary plupload_add" style="margin:10px" >' + _('Add Files') + '</button>&nbsp;' +
                '<button class=" primary plupload_start style="margin:10px">' + _('Start Upload') + '</button>&nbsp;' +
                '</div>' +
                '<div class="plupload_started plupload_hidden"><!-- Hidden -->' +
                '<div class="plupload_progress plupload_right">' +
                '<div class="plupload_progress_container"></div>' +
                '</div>' +
                '<div class="plupload_cell plupload_upload_status" style="margin:10px"></div>' +
                ...
                '<div class="plupload_droptext" style="margin:10px">' + _("Drag files here.") + '</div>' +
    ...
    $.widget("ui.plupload", {
        ...
        _create: function() {
            ...
            if ($.ui.button) {
                ...
                this.browse_button.attr('disabled', false);
                

                this.start_button.attr('disabled', true);
        ...
        _initUploader: function() {
            ...
            uploader.bind('PostInit', function(up) {
                ...
                if (!self.options.buttons.browse) {
                    //self.browse_button.attr('disabled', true).hide();
                    //up.disableBrowse(true);
                } else {
                    self.browse_button.attr('disabled', false);
                }

                if (!self.options.buttons.start) {
                    self.start_button.attr('disabled', true).hide();
                }

                if (!self.options.buttons.stop) {
                    self.stop_button.attr('disabled', true).hide();
                }
        ...
        _setOption: function(key, value) {
            ...
            if (key == 'buttons' && typeof (value) == 'object') {
                ...
                if (!value.browse) {
                    ...
                    self.browse_button.attr('disabled', false).show();
                ...
                if (!value.start) {
                    ...
                    self.start_button.attr('disabled', false).show();
                }
         ...
         */
        disable: function() {
            //this.browse_button.attr('disabled', true);
        ...
        _handleState: function() {
            ...
            if (up.state === plupload.STARTED) {
                ...
                if (up.files.length === (up.total.uploaded + up.total.failed)) {
                    ...
                    this.start_button.attr('disabled', false);
                }
        ...
        _addFiles: function(files) {
            ...
            file_html = '<div class="plupload_file ui-state-default" id="%id%" style="margin:10px;padding:10px;">' +
                    '<div class="plupload_file_thumb" style="float:left; display:inline; width: 150px;">' +
                    '<div class="plupload_file_dummy ui-widget-content"><span class="ui-state-disabled">%ext%</span></div>' +
                    '</div>' +
                    '<div class="image-data" style="display:inline; width: 150px;">' +
                    ...
                    '<label>' +
                    '<input type="radio" class="radio original"  style="margin: -30px"/>' +
