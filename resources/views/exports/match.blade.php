...
<table>
    ...
    <tr>
        ...
        <th style="font-weight: bold;">selected magnitude</th>
        <th style="font-weight: bold;">selected image</th>
        <th style="font-weight: bold;">static image</th>
    ...
    <tbody>
        @foreach($results['results'] as $result)
            <tr>
                ...
                <td>{{ $result['selected_magnitude'] }}</td>
                <td>{{ $result['selected_picture'] }}</td>
                <td>{{ $result['static_picture'] }}</td>
